...
const tritTrot = {
  ...
  sectionLog: [
    ...
    ['1-11', 'fullBody', 'offsetDetails', 'traditionalf', 'shading', 'magic'],
    ['11-22', 'fullBody', 'offsetDetails', 'traditionalf', 'shading', 'magic']
  ]
}
...
const foxJump = {
  ...
  sectionLog: [
    ...
    ['31-41', 'fullBody', 'animationPrinciples', 'offsetDetails', 'traditionalf'],
    ['41-53', 'fullBody', 'animationPrinciples', 'offsetDetails', 'traditionalf'],
    ['55-69', 'fullBody', 'animationPrinciples', 'offsetDetails', 'traditionalf'],
  ]
}
